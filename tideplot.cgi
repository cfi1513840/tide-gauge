...
try:
   ...
   with open('/var/www/html/tideplot.log', 'a') as logfile:
      logfile.write (msgtime+ 'tideplot.cgi sqlite3 connection failed\n')                  
   exit()
#
...
def proc_data():
   ...
   print ('<html>\n')
   print ('<head>\n')
   print (f'<title>{station_location} Tide and Weather</title>\n')
   ...
   print (f'<div style="background-color: #E0F8F1; width: {canvas_width}px; text-align: center; margin-left: auto; margin-right: auto;">\n') 
   print (f'{station_location}<br>')  
   print (f'<form style="background-color: #E0F8F1; width: {canvas_width}px; text-align: center; margin-left: auto; margin-right: auto;" id="myForm" action="/cgi-bin/tideplot.cgi" method="post">\n') 
   print ('<label for="endate">End date:</label>\n')
   print (f'<input type="date" name="endate" id="endate" value="{formdate}">&nbsp&nbsp&nbsp&nbsp\n')
   print ('<label for="dayspan">Plot span in days:</label>\n')
   print (f'<input type="number" name="dayspan" id="dayspan" value="{str(plotdays)}" step=1 min="1" max="30" required>&nbsp&nbsp&nbsp&nbsp\n')
   ...
   print ('<label for="wind"> Wind</label>\n')
   print (f'<input type="checkbox" id="wind" name="wind" value="1" {windchk}>&nbsp&nbsp&nbsp&nbsp\n')
   print ('<label for="rain">Rain</label>\n')
   print (f'<input type="checkbox" id="rain" name="rain" value="1" {rainchk}>&nbsp&nbsp&nbsp&nbsp\n')
   print ('<label for="temp">Temperature</label>\n')
   print (f'<input type="checkbox" id="temp" name="temp" value="1" {tempchk}>&nbsp&nbsp&nbsp&nbsp\n')
   if s1enable:
      print ('<label for="batv">BatV 1</label>\n')
      print (f'<input type="checkbox" id="batv" name="batv" value="1" {batvchk}>&nbsp&nbsp&nbsp&nbsp\n')
   if s2enable:
      print ('<label for="batv2">BatV 2</label>\n')
      print (f'<input type="checkbox" id="batv2" name="batv2" value="0" {batv2chk}>&nbsp&nbsp&nbsp&nbsp\n')
   print ('<input type="submit" value="Refresh"/>\n')
   print ('</form>\n')
   print ('</div>')
   print ('<script>\n')
   print ('var w = window.innerWidth;\n')
   print ('var h = window.innerHeight;\n')
   print ('document.getElementById("screenwidth").value=w;\n')
   print ('document.getElementById("screenheight").value=h;\n')
   print ('</script>\n')     
   print ('<div>\n')
   #print (f'<canvas id="tideplot" width={canvas_width} height={canvas_height}\n')
   print (f'<canvas id="tideplot" width={canvas_width} height={canvas_height}\n')
   print ('style="text-align: center; border:2px solid white; background-color: #E0F8F1">\n')
   print ('</canvas>\n')
   print ('<script>\n')
   print ('var canvas = document.getElementById("tideplot");\n')
   print ('var ctx = canvas.getContext("2d");\n')
   print ('ctx.fillStyle = "#1932E1";\n')
   print ('ctx.strokeStyle = "#1A53FF";\n')
   print ('ctx.textAlign = "left";\n')  
   ...
   if len(tidelist) == 0:
      ...
      print ('ctx.font = "48px Arial";\n')
      print (f'ctx.fillText("No Data Available for Requested Time Span", {int(canvas_width/2)}, {int(canvas_height/2)});\n')
      print ('</script>\n')
      print ('</div>\n')
      print ('</body>\n')
      print ('</html>\n')
...
#
   print ('ctx.lineWidth = 1;\n')
   print ('ctx.fillStyle = "black";\n')
   print ('ctx.font = "12px Arial";\n')
   print ('ctx.globalCompositeOperation = "source-over";\n')
   x_start = 30
   gridx = plot_width
   gridy = tide_end_y
   for x in range(0,tide_grid_nbr+1):
      ...
      print ('ctx.stroke();\n')
      print (f'ctx.fillText("{linbr}", {left_scale_x}, {int(gridy)});\n')
      print (f'ctx.fillText("{linbr}", {right_scale_x}, {int(gridy)});\n')
      gridy = gridy-grid_height
   if station1 and s1enable:
      print ('ctx.strokeStyle = "black";\n')   
      print ('ctx.textAlign = "center";\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({x_start},{vari_start_y});\n')
      print (f'ctx.lineTo({x_start},{vari_end_y});\n')
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width-1},{vari_start_y});\n')
      print (f'ctx.lineTo({plot_width-1},{vari_end_y});\n')
      print ('ctx.stroke();\n')
      gridy = 0
      for x in range(0,vari_grid_nbr+1):
         if x == 0 or x == 2 or x == vari_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(vari_start_y+gridy)});\n')
         print (f'ctx.lineTo({plot_width},{int(vari_start_y+gridy)});\n')
         print ('ctx.stroke();\n')
         print ('ctx.fillStyle = "black";\n')
         print (f'ctx.fillText("{str(2-x)}", {left_scale_x}, {int(vari_start_y+gridy)});\n')                          
         print (f'ctx.fillText("{str(2-x)}", {right_scale_x}, {int(vari_start_y+gridy)});\n')                          
         gridy += grid_height
   if station2 and s2enable:
      print ('ctx.strokeStyle = "black";\n')   
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({x_start},{vari2_start_y});\n')
      print (f'ctx.lineTo({x_start},{vari2_end_y});\n')
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width-1},{vari2_start_y});\n')
      print (f'ctx.lineTo({plot_width-1},{vari2_end_y});\n')
      print ('ctx.stroke();\n')
      gridy = 0   
      for x in range(0,vari_grid_nbr+1):
         if x == 0 or x == 2 or x == vari_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(vari2_start_y+gridy)});\n')
         print (f'ctx.lineTo({plot_width},{int(vari2_start_y+gridy)});\n')
         print ('ctx.stroke();\n')
         print ('ctx.fillStyle = "black";\n')
         print (f'ctx.fillText("{str(2-x)}", {left_scale_x}, {int(vari2_start_y+gridy+3)});\n')                          
         print (f'ctx.fillText("{str(2-x)}", {right_scale_x}, {int(vari2_start_y+gridy+3)});\n')                          
         gridy += grid_height
   if wind:
      gridy = 0
   ...
   if rain:
      ...
      for x in range(0,rain_grid_nbr+1):
         if x == 0 or x == rain_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(rain_start_y+gridy)});\n')
         print (f'ctx.lineTo({plot_width},{int(rain_start_y+gridy)});\n')
         print ('ctx.stroke();\n')
         print ('ctx.fillStyle = "black";\n')
         print (f'ctx.fillText("{str((rain_grid_nbr-x)/2)}", {left_scale_x}, {int(rain_start_y+gridy)});\n')                          
         print (f'ctx.fillText("{str((rain_grid_nbr-x)/2)}", {right_scale_x}, {int(rain_start_y+gridy)});\n')                          
         gridy += rain_grid_y         
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({x_start},{rain_start_y});\n')
      print (f'ctx.lineTo({x_start},{rain_end_y});\n')
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width},{rain_start_y});\n')
      print (f'ctx.lineTo({plot_width},{rain_end_y});\n')
      print ('ctx.stroke();\n') 
   if temp:
      gridy = 0
      for x in range(0,temp_grid_nbr+1):
         if x == 0 or x == temp_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(temp_start_y+gridy)});\n')
      ...
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width},{temp_start_y});\n')
      print (f'ctx.lineTo({plot_width},{temp_end_y});\n')
      print ('ctx.stroke();\n')
   if batv and s1enable:
      gridy = 0
      for x in range(0,batv_grid_nbr+1):
         if x == 0 or x == batv_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(batv_start_y+gridy)});\n')
         print (f'ctx.lineTo({plot_width},{int(batv_start_y+gridy)});\n')
         print ('ctx.stroke();\n')
         print ('ctx.fillStyle = "black";\n')
         print (f'ctx.fillText({format(maxbatv-x*0.05,".2f")}, {left_scale_x}, {int(batv_start_y+gridy+5)});\n')                          
         print (f'ctx.fillText({format(maxbatv-x*0.05,".2f")}, {right_scale_x}, {int(batv_start_y+gridy+5)});\n')                          
         gridy += batv_grid_y        
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({x_start},{batv_start_y});\n')
      print (f'ctx.lineTo({x_start},{batv_end_y});\n')
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width},{batv_start_y});\n')
      print (f'ctx.lineTo({plot_width},{batv_end_y});\n')
      print ('ctx.stroke();\n')       
   if batv2 and s2enable:
      gridy = 0
      for x in range(0,batv2_grid_nbr+1):
         if x == 0 or x == batv2_grid_nbr:
            ...
            print ('ctx.strokeStyle = "gray";\n')
         print ('ctx.beginPath();\n')
         print (f'ctx.moveTo({x_start},{int(batv2_start_y+gridy)});\n')
         print (f'ctx.lineTo({plot_width},{int(batv2_start_y+gridy)});\n')
         print ('ctx.stroke();\n')
         print ('ctx.fillStyle = "black";\n')
         print (f'ctx.fillText({format(maxbatv2-x*0.05,".2f")}, {left_scale_x}, {int(batv2_start_y+gridy+5)});\n')                          
         print (f'ctx.fillText({format(maxbatv2-x*0.05,".2f")}, {right_scale_x}, {int(batv2_start_y+gridy+5)});\n')                          
         gridy += batv2_grid_y         
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({x_start},{batv2_start_y});\n')
      print (f'ctx.lineTo({x_start},{batv2_end_y});\n')
      print ('ctx.stroke();\n')
      print ('ctx.beginPath();\n')
      print (f'ctx.moveTo({plot_width},{batv2_start_y});\n')
      print (f'ctx.lineTo({plot_width},{batv2_end_y});\n')
      print ('ctx.stroke();\n')             
   ...
   for pidx, ent in enumerate(predlist):
            ...
            while tidetime == predtime_hm and aidx < tidelen-1:
               if station1 and s1enable and tidelist[aidx][1] == 1:
                  ...
                  if savetime == 0 or tidetime > savetime + timedelta(minutes=15):               
                     ...
                     print (f'ctx.strokeStyle = "blue";\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({savex},{savey});\n')
                     print (f'ctx.lineTo({tide_x},{tide_y});\n')
                     print (f'ctx.stroke();\n')                                    
                  savetime = tidetime
                  savex = tide_x
                  savey = tide_y
                  if predstate == 'L' or predstate == 'H':
                     if prestate == '':
                        ...
                        if variinit:
                           print (f'ctx.strokeStyle = "blue";\n')
                           print (f'ctx.beginPath();\n')
                           print (f'ctx.moveTo({varistart_x},{varistart_y});\n')
                           print (f'ctx.lineTo({tide_x},{vari_y});\n')
                           print (f'ctx.stroke();\n')                                    
                           varistart_x = tide_x
                           varistart_y = vari_y
                        variinit = True
                  ...
                  if savetime2 == 0 or tidetime > savetime2 + timedelta(minutes=15):               
                     ...
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({savex2},{savey2});\n')
                     print (f'ctx.lineTo({tide_x},{tide_y});\n')
                     print (f'ctx.stroke();\n')                                    
                  savetime2 = tidetime
                  savex2 = tide_x
                  ...
                  if predstate == 'L' or predstate == 'H':
                     if prestate2 == '':
                        ...
                        if vari2init:
                           print (f'ctx.strokeStyle = "darkgreen";\n')
                           print (f'ctx.beginPath();\n')
                           print (f'ctx.moveTo({vari2start_x},{vari2start_y});\n')
                           print (f'ctx.lineTo({tide_x},{vari_y});\n')
                           print (f'ctx.stroke();\n')                                    
                           vari2start_x = tide_x
                           vari2start_y = vari_y
         ...
         if s1enable and batv and len(batvlist) != 0:
            if batvtime == predtime_hm:
               ...
               if savebatvtime == 0 or predtime_hm > savebatvtime + timedelta(minutes=15):               
                  #print ('ctx.fillStyle = "black";\n')
                  #print (f'ctx.fillRect({tide_x},{batv_y},1,2);\n')
                  pass
               else:
                  print (f'ctx.strokeStyle = "black";\n')
                  print (f'ctx.beginPath();\n')
                  print (f'ctx.moveTo({savebatvx},{savebatvy});\n')
                  print (f'ctx.lineTo({tide_x},{batv_y});\n')
                  print (f'ctx.stroke();\n')                                    
                  if str(predtime_hm) == localsunrise:
                     print (f'ctx.strokeStyle = "orange";\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv_start_y});\n')
                     print (f'ctx.lineTo({predstartx},{batv_end_y});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv_start_y});\n')
                     print (f'ctx.lineTo({predstartx-10},{batv_start_y+10});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv_start_y});\n')
                     print (f'ctx.lineTo({predstartx+10},{batv_start_y+10});\n')
                     ...
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv_end_y});\n')
                     print (f'ctx.lineTo({predstartx-10},{batv_end_y-10});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv_end_y});\n')
                     print (f'ctx.lineTo({predstartx+10},{batv_end_y-10});\n')
         ...
         if s2enable and batv2 and len(batv2list) != 0:
            if batv2time == predtime_hm:
               ...
               if savebatv2time == 0 or predtime_hm > savebatv2time + timedelta(minutes=15):               
                  #print ('ctx.fillStyle = "black";\n')
                  #print (f'ctx.fillRect({tide_x},{batv2_y},1,2);\n')
                  pass
               else:
                  print (f'ctx.strokeStyle = "black";\n')
                  print (f'ctx.beginPath();\n')
                  print (f'ctx.moveTo({savebatv2x},{savebatv2y});\n')
                  print (f'ctx.lineTo({tide_x},{batv2_y});\n')
                  print (f'ctx.stroke();\n')                                    
                  if str(predtime_hm) == localsunrise:
                     print (f'ctx.strokeStyle = "orange";\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv2_start_y});\n')
                     print (f'ctx.lineTo({predstartx},{batv2_end_y});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv2_start_y});\n')
                     print (f'ctx.lineTo({predstartx-10},{batv2_start_y+10});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv2_start_y});\n')
                     print (f'ctx.lineTo({predstartx+10},{batv2_start_y+10});\n')
                     ...
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv2_end_y});\n')
                     print (f'ctx.lineTo({predstartx-10},{batv2_end_y-10});\n')
                     print (f'ctx.stroke();\n')
                     print (f'ctx.beginPath();\n')
                     print (f'ctx.moveTo({predstartx},{batv2_end_y});\n')
                     print (f'ctx.lineTo({predstartx+10},{batv2_end_y-10});\n')
      ...
      if predtime.minute == 0 and predtime.hour  == 0:
         print ('ctx.strokeStyle = "gray";\n')
         print (f'ctx.beginPath();\n')
         print (f'ctx.moveTo({predstartx},{tide_start_y});\n')
         print (f'ctx.lineTo({predstartx},{tide_end_y});\n')
         print (f'ctx.stroke();\n')                                                                     
         print (f'ctx.beginPath();\n')
         if station1:
            print (f'ctx.moveTo({predstartx},{vari_start_y});\n')
            print (f'ctx.lineTo({predstartx},{vari_end_y});\n')
            print (f'ctx.stroke();\n')
         if station2:
            print (f'ctx.moveTo({predstartx},{vari2_start_y});\n')
            print (f'ctx.lineTo({predstartx},{vari2_end_y});\n')
            print (f'ctx.stroke();\n')
         if wind:
            print (f'ctx.beginPath();\n')
            print (f'ctx.moveTo({predstartx},{wind_start_y});\n')
            print (f'ctx.lineTo({predstartx},{wind_end_y});\n')
            print (f'ctx.stroke();\n')
         if rain:
            print (f'ctx.beginPath();\n')
            print (f'ctx.moveTo({predstartx},{rain_start_y});\n')
            print (f'ctx.lineTo({predstartx},{rain_end_y});\n')
            print (f'ctx.stroke();\n')
         if temp:
            print (f'ctx.beginPath();\n')
            print (f'ctx.moveTo({predstartx},{temp_start_y});\n')
            print (f'ctx.lineTo({predstartx},{temp_end_y});\n')
            print (f'ctx.stroke();\n')
      ...
      if predtime.minute == 0 and predtime.hour == 12:
         print (f'ctx.fillText("{linedate}", {predstartx}, {dtime_start_y+17});\n')                          
         print (f'ctx.fillText("{linedate}", {predstartx}, {canvas_height-5});\n')                          
      if pidx % 10 == 0:
         print (f'ctx.strokeStyle = "gray";\n')
         print (f'ctx.beginPath();\n')
         print (f'ctx.moveTo({predstarthx},{predstarthy});\n')
         print (f'ctx.lineTo({predendx},{predendy});\n')
         print (f'ctx.stroke();\n')
               ...
               if wind and wxinit:
                  if wxlist[widx][4] != '' and wxlist[widx][4] is not None:
                     ...
                     if windcount == 5:
                        ...
                        print (f'ctx.beginPath();\n')
                        print (f'ctx.moveTo({wxstartx},{wxstarty});\n')
                        print (f'ctx.lineTo({wxendx},{wxendy});\n')
                        print (f'ctx.stroke();\n')
                        wxstartx = wxendx
                        wxstarty = wxendy
                        windcount = 0
                        ...
                        if wxendx > windex+10 and maxwind > 2:
                           ...
                           print (f'ctx.lineTo({newarrow[1][0]},{newarrow[1][1]});\n')
                           print (f'ctx.stroke();\n')
                           print (f'ctx.beginPath();\n')
                           print (f'ctx.moveTo({newarrow[0][0]},{newarrow[0][1]});\n')
                           print (f'ctx.lineTo({newarrow[2][0]},{newarrow[2][1]});\n')
                           print (f'ctx.stroke();\n')
                           print (f'ctx.beginPath();\n')
                           print (f'ctx.moveTo({newarrow[0][0]},{newarrow[0][1]});\n')
                           print (f'ctx.lineTo({newarrow[3][0]},{newarrow[3][1]});\n')
                           print (f'ctx.stroke();\n')
                        maxwdir = 0
                        maxwind = 0
               elif wind:
               ...
               if rain and rxinit:
                  if wxlist[widx][10] != '' and wxlist[widx][10] is not None:
                     ...
                     if widx % 10 == 0:
                        print (f'ctx.strokeStyle = "black";\n')
                        print (f'ctx.beginPath();\n')
                        print (f'ctx.moveTo({rxstarthx},{rxstarthy});\n')
                        print (f'ctx.lineTo({rxendx},{rxendy});\n')
                        print (f'ctx.stroke();\n')
                        rxstarthx = rxendx
                        rxstarthy = rxendy
                     rxstartx = rxendx
               ...
               if temp and txinit:
                  if wxlist[widx][1] != '' and wxlist[widx][1] is not None:
                     ...
                     if widx % 10 == 0:
                        ...
                        print (f'ctx.beginPath();\n')
                        print (f'ctx.moveTo({txstarthx},{txstarthy});\n')
                        print (f'ctx.lineTo({txendx},{txendy});\n')
                        print (f'ctx.stroke();\n')
                        txstarthx = txendx
                        txstarthy = txendy
                     txstartx = txendx
   ...
   print (f'ctx.strokeStyle = "black";\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({x_start},{tide_start_y});\n')
   print (f'ctx.lineTo({x_start},{tide_end_y});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.moveTo({plot_width-1},{tide_start_y});\n')
   print (f'ctx.lineTo({plot_width-1},{tide_end_y});\n')
   print (f'ctx.stroke();\n')
#
            ...
            if s1enable and station1 and ent[1] == 1:
               ...
               if tidestate == 'low' or tidestate == 'high':
                  if turntime == '' or abs(hourtime-turntime) >= 3:
                     ...
                     print (f'ctx.fillRect({startx-21}, {tag_y-19}, 42, 30);\n')
      ...
      if predstate == 'L' or predstate == 'H':
         ...
         if prestate == '':
            ...
            while dash_end_y < tide_end_y:
               print (f'ctx.beginPath();\n')
               print (f'ctx.moveTo({endx},{dash_end_y});\n')
               if dash_end_y+dash_size > tide_end_y:
                  print (f'ctx.lineTo({endx},{tide_end_y});\n')
               else:
                  print (f'ctx.lineTo({endx},{dash_end_y+dash_size});\n')
               print (f'ctx.stroke();\n')
            ...
            if s1enable and station1:
               ...
               while dash_end_y < vari_end_y:
                  ...
                  if dash_end_y+dash_size > vari_end_y:
                     print (f'ctx.lineTo({endx},{vari_end_y});\n')
                  else:
                     print (f'ctx.lineTo({endx},{dash_end_y+dash_size});\n')
                  print (f'ctx.stroke();\n')
                  dash_end_y += dash_size*2
            if s2enable and station2:
               ...
               while dash_end_y < vari2_end_y:
                  ...
                  if dash_end_y+dash_size > vari2_end_y:
                     print (f'ctx.lineTo({endx},{vari2_end_y});\n')
                  else:
                     print (f'ctx.lineTo({endx},{dash_end_y+dash_size});\n')
                  print (f'ctx.stroke();\n')
                  dash_end_y += dash_size*2
            ...
            if tags:                  
               print (f'ctx.fillStyle = "#ffffff";\n')
               print (f'ctx.strokeRect({startx-21}, {tag_y+13}, 42, 30);\n')
               print (f'ctx.fillRect({startx-21}, {tag_y+13}, 42, 30);\n')
               print (f'ctx.fillStyle = "gray";\n')
               print (f'ctx.fillText("{peak}", {startx}, {tag_y+27});\n')
               print (f'ctx.fillText("{hrmin}", {startx}, {tag_y+42});\n')
         startx = endx
         #starty = endy
   print (f'ctx.strokeStyle = "blue";\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4-60},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4-30},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4+30},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4+60},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.strokeStyle = "darkgreen";\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4*2-60},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4*2-30},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4*2+30},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4*2+60},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.strokeStyle = "gray";\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4*3-70},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4*3-40},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print (f'ctx.beginPath();\n')
   print (f'ctx.moveTo({plot_width/4*3+40},{tide_start_y-10});\n')
   print (f'ctx.lineTo({plot_width/4*3+70},{tide_start_y-10});\n')
   print (f'ctx.stroke();\n')
   print ('ctx.textAlign = "center";\n')
