...
try: 
   ...
   if len(users) != 0:
      ...
      print (f'Password updated for {databaseEmailAddress}. Please close this tab and return to the login screen.')
      print ('</p>')
      print ('</span>')
      print ('</div>')
      print ('</font></body>')
      ...
      print (f'The password update request has expired. Please close this tab and return to the login screen.')
      print ('</p>')
      print ('</span>')
      print ('</div>')
      print ('</font></body>')
